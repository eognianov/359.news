...
namespace NewsSystem.Worker.Common
{
    ...
    public class OneLineConsoleLoggerProvider : ILoggerProvider
    {
        ...
        public class CustomConsoleLogger : ILogger
        {
            ...
            {
                this.useConsole = useConsole;
                this.categoryName = categoryName.Replace("NewsSystem.Worker.Runner.", string.Empty)
                    .Replace("NewsSystem.Worker.Tasks.", string.Empty)
                    .Replace("NewsSystem.Worker.Common.", string.Empty);
            }
