    ...
    public class SourcesSeeder : ISeeder
    {
        public void Seed(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            var sources = new List<(string typeName, string shortName, string name, string description, string url)>
                          {
                              ("NewsSystem.Services.Sources.Ministries.MvrBgAktualnoSource",
                                  ...
                                  "https://www.mvr.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.ModBgSource",
                                  ...
                                  "https://www.mod.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.NsiBgNewsSource",
                                  ...
                                  "https://www.nsi.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.NsiBgPressSource",
                                  "НСИ", "Национален статистически институт - Прессъобщения",
                                  "Националният статистически институт на Република България (НСИ) е държавна агенция, пряко подчинена на Министерския съвет, която се занимава с набиране, обработване и предоставяне на точна информация за цялостното социално и икономическо състояние и развитие на България.",
                                  "https://www.nsi.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.GovernmentBgSource",
                                  "МС", "Министерски съвет",
                                  "Министерският съвет (Правителството) е основен орган на изпълнителната власт в Република България.",
                                  "http://www.government.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.FscBgSource",
                                  ...
                                  "http://www.fsc.bg/bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.ApiBgSource",
                              ...
                              ("NewsSystem.Services.Sources.BgInstitutions.PrbBgSource",
                                  ...
                                  "https://www.prb.bg/bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.ParliamentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MpesGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.BgInstitutions.PresidentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.BgInstitutions.CustomsBgOnFocusSource",
                                  "Митниците", "Агенция \"Митници\" - На фокус",
                                  "Агенция „Митници“ е централизирана административна структура към министъра на финансите.",
                                  "https://customs.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.NapBgSource",
                                  ...
                                  "http://www.nap.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.NoiBgSource",
                                  ...
                                  "http://www.noi.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.OmbudsmanBgSource",
                              ...
                              ("NewsSystem.Services.Sources.BgStateCompanies.ToploBgSource",
                                  ...
                                  "https://toplo.bg/"),
                              ("NewsSystem.Services.Sources.BgStateCompanies.CezBgSource",
                                  ...
                                  "http://www.cez.bg/"),
                              ("NewsSystem.Services.Sources.BgStateCompanies.PirogovEuSource",
                                  ...
                                  "https://pirogov.eu/"),
                              ("NewsSystem.Services.Sources.BgNgos.ImeBgSource",
                                  ...
                                  "https://ime.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.CustomsBgNewsSource",
                                  "Митниците", "Агенция \"Митници\" - Новини",
                                  "Агенция „Митници“ е централизирана административна структура към министъра на финансите.",
                                  "https://customs.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MjsBgSource",
                                  ...
                                  "http://www.mjs.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MeGovernmentBgHotNewsSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MeGovernmentBgNewsSource",
                                  "МЕ", "Министерство на енергетиката - Новини",
                                  "Министерството на енергетиката (МЕ) има основни задачи по проектиране, научноизследователска дейност, поддържане и експлоатация на енергийните съоръжения на територията на страната, производство и пренос на топлинна и електрическа енергия, добив и преработка на рудни и нерудни изкопаеми, използване на водните ресурси за добив на ток и други.",
                                  "https://www.me.government.bg/bg/news.html"),
                              ("NewsSystem.Services.Sources.Ministries.MvrBgNoviniSource",
                                  "МВР", "Министерство на вътрешните работи - Новини",
                                  "Министерството на вътрешните работи (МВР) е българска държавна институция с ранг на министерство, която се грижи за защитата на националната сигурност, борбата с престъпността, опазването на обществения ред и други.",
                                  "https://www.mvr.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MvrBgInformacionenBiuletinSource",
                                  "МВР", "Министерство на вътрешните работи - Информационен бюлетин",
                                  "Министерството на вътрешните работи (МВР) е българска държавна институция с ранг на министерство, която се грижи за защитата на националната сигурност, борбата с престъпността, опазването на обществения ред и други.",
                                  "https://www.mvr.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MvrBgPutnaObstanovkaSource",
                                  "МВР", "Министерство на вътрешните работи - Пътна обстановка",
                                  "Министерството на вътрешните работи (МВР) е българска държавна институция с ранг на министерство, която се грижи за защитата на националната сигурност, борбата с престъпността, опазването на обществения ред и други.",
                                  "https://www.mvr.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MhGovernmentBgNewsSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MrrbBgSource",
                                  ...
                                  "https://www.mrrb.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MonBgSource",
                                  ...
                                  "https://www.mon.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MfaBgSource",
                                  ...
                                  "https://www.mfa.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MlspBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MzhGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MinFinBgSource",
                                  ...
                                  "https://www.minfin.bg/"),
                              ("NewsSystem.Services.Sources.Ministries.MiGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.McGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.TourismGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MtitcGovernmentBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MoewGovernmentBgNationalNewsSource",
                              ...
                              ("NewsSystem.Services.Sources.Ministries.MoewGovernmentBgRegionalNewsSource",
                                  "МОСВ", "Министерство на околната среда и водите - Регионални новини",
                                  "Министерството на околната среда и водите разработва и провежда държавната политика в областта на околната среда, като основните й аспекти са свързани със: законодателна инициатива, стратегическо планиране, изпълнение на секторните политики, упражняване на превантивна дейности и управление на програми и проекти.",
                                  "https://www.moew.government.bg/"),
                              ("NewsSystem.Services.Sources.BgNgos.BivolBgSource",
                                  "Биволъ", "Биволъ",
                                  "„Биволъ“ е български сайт за разследваща журналистика. Създатели и основни автори в него са Асен Йорданов и Атанас Чобанов.",
                                  "https://bivol.bg/"),
                              ("NewsSystem.Services.Sources.BgNgos.GallupInternationalBgSource",
                              ...
                              ("NewsSystem.Services.Sources.Municipalities.SofiaBgSource",
                                  "СО", "Столична община",
                                  "Столична община е административна единица, включваща град София и е единствената община в област София.",
                                  "https://www.sofia.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.BfunionBgSource",
                                  ...
                                  "https://bfunion.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.KzpBgSource",
                                  ...
                                  "https://kzp.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.BasBgSource",
                                  ...
                                  "http://www.bas.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.CpdpBgSource",
                                  ...
                                  "https://www.cpdp.bg/"),
                              ("NewsSystem.Services.Sources.BgInstitutions.CiafGovernmentBgSource",
